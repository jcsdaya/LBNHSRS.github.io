...
<body>
   ...
   <div class="container">
        ...
        $sql = "SELECT files.id, files.file_name, files.file_type FROM files join bookmark on files.id = bookmark.id";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='card mb-4'>
                        <div class='card-body'>
                            ...
                            <a class='btn btn-secondary btn-block btn-link' href='preview.php?id=$fileId'>View Details</a>
                            <a class='btn btn-info btn-block btn-bookmark' data-file-id='$fileId'>Bookmark</a>
                        </div>
                      </div>";
            }
        } else {
